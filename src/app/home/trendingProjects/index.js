...
const TrendingProjects = () => {
    return (<div className='trending-projects'>
        <CardSlider carouselSettings={{slidesToShow:1.5, slidesToScroll:1, responsive: [],autoplay:true, nextArrow:null, prevArrow:null, autoplaySpeed: 2000, infinite:false}}>
