...
const TrendingProjects = async () => {
    ...
    return (
        <div className='trending-projects'>
            <CardSlider carouselSettings={{  slidesToShow: null, slidesToScroll: 1, variableWidth: true, infinite: true, responsive: [], autoplay: true, nextArrow: null, prevArrow: null, autoplaySpeed: 2000 }}>
