...
import RightLink from '@/app/icons/right_arrow.svg';
...
export default function Page({params,
    ...
    return (<div className='search-page container-fluid'>
        ...
        <Link className='d-flex justify-content-end align-items-center property-detail-link sub-heading' href={"/property/" + searchParams?.id}>View Full Details <Image src={RightLink} width={28} height={28} /></Link>
